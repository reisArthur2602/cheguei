...
export const ExamPage = () => {
    ...
    const { mutateAsync: updateStudyStatusFn } = useMutation({
    ...
    const handleSubmit = async () => await updateStudyStatusFn({ studyId: study!.id });
    ...
    return (
        <div className="flex-1 flex flex-col gap-8">
            ...
            {!loading && !study && (
                <EmptyState
                    title="Exame ainda não disponível"
                    description="O seu exame ainda está sendo processado ou aguardando liberação. Tente novamente mais tarde."
                ...
                <>
                    <div className="text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <p className="text-muted-foreground text-lg">
                            Exames disponíveis para retirada
                        </p>
                    </div>
